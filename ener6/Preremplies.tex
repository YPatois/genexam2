...
\baremeDefautM{e=0,v=0,b=.25,m=-.1}
...
% Ces deux questions n'ont par erreur jamais été données.
% Le barème est incorrect, mais c'est sans importance ici.
\element{sources}{
...
\element{carbone}{
  \begin{questionmult}{carb1}\baremeDefautM{e=0,v=0,b=.25,m=0}
    Coche les sources d'énergie carbonées~:
    % Pour ne pas régérer le layout (toujours dangereux), vu l'imprécision de l'énoncé, on a juste modifié le barème global.
    \begin{reponses}
