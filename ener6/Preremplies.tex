...
\baremeDefautM{e=0,v=0,b=.5,m=-.25}
...
\vspace*{5mm}
  ...
  Si vous faites une erreur et que vous ne pouvez effacer, raturez la case.
...
\element{carbone}{
  \begin{questionmult}{carb1}
    ...
    \end{reponses}
    \explain{Ici l'énoncé était imprécis: on aurait dû lire \emph{Les sources d'énergie carbonées \bf{fossiles}}}
  \end{questionmult}
}
