...
\begin{questionmult}{acidbenzo1}
    ...
    \AMCOpen{}{
        ...
        \bonne{Groupe identifié}\scoring{b=1}
        \bonne{Groupe nommé}\scoring{b=1}
    }
...
\begin{question}{acidbenzo2}
    ...
    \end{EnvQuadrillage}
    \AMCOpen{}{
        \mauvaise{NA}\scoring{0}
        \mauvaise{$\approx$}\scoring{1}
        \bonne{OK}\scoring{2}
    }
...
\begin{questionmult}{acidbenzo4}
    ...
    \AMCOpen{}{
        \mauvaise{NA}\scoring{b=0}
        \bonne{Expérience identifiée}\scoring{b=1}
        \bonne{Justification correcte}\scoring{b=1}
    }
    \explain{
...
\begin{question}{acidbenzo6}
    ...
    \end{EnvQuadrillage}
    \AMCOpen{}{
        \mauvaise[F]{NA}\scoring{0}
        \mauvaise[C]{$\approx$}\scoring{1}
        \bonne[C]{OK}\scoring{2}
    }
...
\begin{questionmult}{acidbenzo7}
    ...
    \AMCOpen{}{
        ...
        \bonne[C]{ScBuoy}\scoring{b=1}
        \bonne[C]{ScAcd}\scoring{b=1}
        \bonne[C]{XpBuoy}\scoring{b=1}
        \bonne[C]{Ovl}\scoring{b=1}
   }
    \explain{
    \begin{minipage}[t]{0.3\textwidth}
        \centering
...
\begin{question}{acidbenzo8}
    ...
    \AMCOpen{}{
        \mauvaise[F]{NA}\scoring{0}
        \mauvaise[B]{$\approx$}\scoring{1}
        \bonne[A]{OK}\scoring{2}
   }
...
\begin{questionmult}{acidbenzo9}
    ...
    \AMCOpen{}{
        ...
        \bonne{Forml}\scoring{b=1}
        \bonne{Nb}\scoring{b=1}
        \bonne{Ovl}\scoring{b=1}
    }
...
\begin{questionmult}{acidbenzo10}
    ...
    \AMCOpen{}{
        \mauvaise[F]{NA}\scoring{b=0}
        \bonne[C]{Idée}\scoring{b=1}
        \bonne[B]{Forml}\scoring{b=1}
        \bonne[A]{Nb}\scoring{b=1}
        \bonne[A]{Ovl}\scoring{b=1}
    }
    \explain{
