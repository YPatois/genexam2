...
\element{nomd}{ % Ici pas de numération
  \begin{questionmult}{nomd16}
    Quel est la formule topologique du 3-éthyl-4-méthylhexan-2-one~?
    \begin{reponses}
      \bonne{{\tiny \chemfig{O=[:270](-[:210])-[:330](-[:270]-[:210])-[:30](-[:90])-[:330]-[:30]}}} % Déplacement du groupe fonctionnel
...
\element{nomd}{ % Ici pas de numération
  \begin{questionmult}{nomd18}
    Quelle est la formule topologique de l'acide 2-méthylpropanoïque~?
    \begin{reponses}
      \bonne{{\tiny \chemfig{OH-[:150,,1](=[:90]O)-[:210](-[:270])-[:150]}}} % Methyl en position 3
