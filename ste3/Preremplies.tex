...
\baremeDefautM{fformula=(NMC>3 ? NBC-int(NBC/3):NBC)}
...
%%% fin des elements
\element{groupes}{
\section{Petite révision (questions simples)}
\begin{multicols}{2}
\insertgroup[1]{penti}
\insertgroup[1]{p10}
\insertgroup[1]{psi}
\insertgroup[1]{atcomp}
\insertgroup[1]{sym}
\insertgroup[1]{iso}
\end{multicols}
...
\section{Fonctions chimiques}
\begin{multicols}{2}
\insertgroup[4]{fonchi}
\end{multicols}

\section{Nomenclatures (moins simple)}
\begin{multicols}{2}
\insertgroup[4]{nomc}
\insertgroup[8]{nomd}
\end{multicols}
...
\newpage
\section{Compter les hydrogènes}
\begin{multicols}{2}
\insertgroup[2]{brut}
\end{multicols}
\AMCcleardoublepage
