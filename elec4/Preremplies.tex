...
\element{symboles}{
  \begin{question}{sym5}
    ...
    \begin{reponses}
      ...
      \mauvaise{Ne laisse toujours passer le courant}
      \mauvaise{Ne ne laisse jamais passer le courant}
    \end{reponses}
  \end{question}
}
...
\element{mesures}{
  \begin{question}{mes5}
    L'appareil affiche cet écran lors d'une mesure en voltmètre ou en ampèremètre, alors~:
    \\
