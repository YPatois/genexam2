...
\element{calculs}{
  \begin{question}{cal1}
    Dans un circuit électrique monté en série~:
    \begin{reponses}
      \bonne{La loi d'unicité de l'intensité du courant électrique pose que l'intensité du courant électrique est la même en tout point du circuit}
      ...
      \mauvaise{La loi d’additivité des intensités du courant électrique pmose que l’intensité du courant électrique dans le générateur est égal à la somme des intensités des courants dans chaque dipole}
      \mauvaise{La loi d'unicité des tensions électriques pose que la tension électrique est la même aux bornes de chaque ddipoles du circuit}
    \end{reponses}
  \end{question}
}
...
\element{calculs}{
  \begin{question}{cal2}
    Dans un circuit électrique monté en dérivation~:
    \begin{reponses}
      ...
      \bonne{La loi d’additivité es intensités du courant électrique pose que l’intensité du courant électrique dans le générateur est égal à la somme des intensités des courants dans chaque dipole}
