...
\element{calculs}{
  \FPeval\ySeed{trunc(random*1000,0) }
  \input{"|./genexo.py --seed \ySeed~ --mode A --level 0 --qref cal6"}
}

\element{calculs}{
  \FPeval\ySeed{trunc(random*1000,0) }
  \input{"|./genexo.py --seed \ySeed~ --mode A --level 1 --qref cal7"}
}

\element{calculs}{
  \FPeval\ySeed{trunc(random*1000,0) }
  \input{"|./genexo.py --seed \ySeed~ --mode A --level 2 --qref cal8"}
}

\element{calculs}{
  \FPeval\ySeed{trunc(random*1000,0) }
  \input{"|./genexo.py --seed \ySeed~ --mode A --level 3 --qref cal8"}
}

\element{calculs}{
  \FPeval\ySeed{trunc(random*1000,0) }
  \input{"|./genexo.py --seed \ySeed~ --mode A --level 4 --qref cal8"}
}
