...
\element{mesures}{
  \begin{question}{mes4}
   ...
   \end{reponsesd}
   \explain{On commence toujours par le calibre le plus grand pour éviter d'endomager l'appareil de mesure. Toutefois, le calibre 10A n'étant pas protégé par un fusible, nous ne l'utilisons pas.}
  \end{question}
}
