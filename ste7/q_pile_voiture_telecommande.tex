...
Une pile alcaline AA du commerce de type Power+ est reliée à une résistance de \SI{10}{\ohm}. L’intensité est mesurée à l’aide d’un ampèremètre. La courbe de l’évolution de l’intensité $I$ débitée au cours du temps est donnée Figure~\ref{fig:pile_alcaline_graph}.
...
\begin{questionmult}{pileA8}
    ...
    \explain{
    L'intensité moyenne délivrée par la pile Power+ est d'environ $\SI{100}{\milli\ampere}$. La capacité $Q_{P+}$ est donnée par $Q = I \times t = \SI{100e-3}{\ampere} \times \SI{28 \times 3600}{\second} = \SI{10080}{\coulomb}$.
    }
\end{questionmult}
