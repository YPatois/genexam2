...
{\Large\bf Évaluation sur table STL - Physique-Chimie 07/01/2025}
...
\begin{multicols}{2}
\insertgroup[4]{simplenum}
%\insertgroup[4]{power10}
%\insertgroup[4]{psi}
%\insertgroup[2]{atoms}
...
%\begin{multicols}{2}
%\insertgroup[4]{falcans}
%\insertgroup[4]{alcans}
%\insertgroup[8]{alcools}
%\insertgroup[4]{groups}
%\insertgroup[4]{nomencla}
%\insertgroup[4]{isors}
%\insertgroup[4]{isoze}
%\end{multicols}
