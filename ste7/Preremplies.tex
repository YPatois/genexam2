...
%\begin{multicols}{2}
%\insertgroup[4]{defacidebase}
%\insertgroup[4]{phconcentration}
%\insertgroup[4]{pkaforce}
%\insertgroup[2]{tampons}
%\end{multicols}

%\textbf{Logarithme: la fonction $\log$ représente le logarithme décimal ($\log_{10}$).}
%\begin{multicols}{2}
%\insertgroup[4]{logs}
%\end{multicols}
