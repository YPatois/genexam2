...
\medskip
\noindent
\textbf{Q1.} Justifier l’appartenance de chacune de ces deux molécules à la famille des acides aminés en entourant et en nommant sur le \textbf{document réponse DR2 en page~\AMCpageref{page:acide_amine_DR2}} (à rendre avec la copie), les groupes caractéristiques responsables.
...
\[
\begin{array}{l}
\mathrm{p}K_a \left(\ce{^+H3N-CH2-COOH} / \ce{^+H3N-CH2-COO-}\right) = 2{,}4 \\
\mathrm{p}K_a \left(\ce{^+H3N-CH2-COO-} / \ce{H2N-CH2-COO-}\right) = 9{,}7 \\
\end{array}
\]
