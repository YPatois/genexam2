...
\begin{questionmult}{ibuprofene1}
    ...
    \explain{
        La formule topologique de l'ibuprofène doit montrer~:
        \begin{itemize}
            \item Un groupe carboxyle ($-COOH$).
            \item Un carbone asymétrique (noté $C^*$).
            \item Un groupe méthyle ($-CH_3$) et un groupe phényle (représenté par $MPP$).
        \end{itemize}
        \chemfig{
...
\begin{questionmult}{ibuprofene2}
    ...
    Ce groupe définit la famille fonctionnelle~:
    \begin{itemize}
...
\begin{questionmult}{ibuprofene5}
    ...
    \begin{itemize}
        ...
        \item Si les trois groupes restants sont classés dans le sens horaire, la configuration est $R$. Sinon, elle est $S$.
    \end{itemize}
    \begin{center}
...
\begin{questionmult}{ibuprofene6}
    ...
    \explain{
    \begin{itemize}
        \item Le mélange racémique n'est pas dangereux car l'énantiomère $R$ est inactif mais inoffensif.
        \item L'action est retardée car le corps doit convertir l'énantiomère $R$ en $S$ par une réaction enzymatique, ce qui prend du temps.
    \end{itemize}
    }
\end{questionmult}
...
\begin{questionmult}{ibuprofene7}
    ...
    \begin{itemize}
        ...
        \item La base conjuguée de l'ibuprofène conserve le carbone asymétrique, donc elle possède les mêmes propriétés stéréochimiques que la forme acide.
    \end{itemize}
    }
\end{questionmult}
