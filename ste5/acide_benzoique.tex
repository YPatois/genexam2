...
L'acide benzoïque, de formule \ce{C6H5COOH}, et le benzoate de sodium sont des conservateurs antimicrobiens respectivement identifiés par les codes E210 et E211. Ils sont présents dans de nombreux produits alimentaires et notamment dans certaines boissons gazeuses sucrées. À température ambiante, l’acide benzoïque est un solide blanc.
...
L’objectif de cet exercice est de vérifier l’indication d’une étiquette de boisson gazeuse concernant la présence d’un conservateur.

\section*{Questions}

\begin{question}{ouverte1}
Entourer et nommer les groupes caractéristiques présents dans la formule topologique de l'acide benzoïque ci-dessus.
\begin{EnvQuadrillage}[NbCarreaux=20x3,Grille=Seyes,Marge=1]
\end{EnvQuadrillage}
\AMCOpen{non-reponse}{0}\AMCOpen{groupe-identifie}{1}\AMCOpen{groupe-nomme}{1}
\explain{
...
\begin{EnvQuadrillage}[NbCarreaux=21x4,Grille=Seyes,Marge=1]
\end{EnvQuadrillage}
\AMCOpen{non-reponse}{0}\AMCOpen{groupes-identifies}{2}
\explain{
...
\end{EnvQuadrillage}
\AMCOpen{non-reponse}{0}\AMCOpen{explication-correcte}{2}
\explain{
L'acide benzoïque est peu soluble dans l'eau en raison de son caractère hydrophobe (cycle benzénique) et de la formation de liaisons hydrogène intramoléculaires. En revanche, il est très soluble dans l'éther éthylique, un solvant organique apolaire, en raison de sa structure aromatique.
}
\end{question}
...
\begin{EnvQuadrillage}[NbCarreaux=21x2,Grille=Seyes,Marge=1]
\end{EnvQuadrillage}
\AMCOpen{non-reponse}{0}\AMCOpen{reaction-correcte}{2}
\explain{
...
\begin{EnvQuadrillage}[NbCarreaux=21x2,Grille=Seyes,Marge=1]
\end{EnvQuadrillage}
\AMCOpen{non-reponse}{0}\AMCOpen{espece-correcte}{2}
\explain{
À un pH de 3, l'espèce prédominante est l'acide benzoïque (\ce{C6H5COOH}), car le pH est inférieur au pKa du couple.
}
\end{question}
