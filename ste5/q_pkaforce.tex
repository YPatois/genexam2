\element{pkaforce}{
    \begin{question}{pkaforce1}
        ...
        \end{reponses}
        \explain{Le pKa est défini comme l'opposé du logarithme de la constante d'acidité $K_a$, soit $\text{p}K_a = -\log(K_a)$.}
    \end{question}
}
...
\element{pkaforce}{
    \begin{question}{pkaforce2}
        ...
        \end{reponses}
        \explain{Un pKa faible indique une constante d'acidité $K_a$ élevée, ce qui signifie que l'acide est fort.}
    \end{question}
}
...
\element{pkaforce}{
    \begin{question}{pkaforce3}
        ...
        \end{reponses}
        \explain{À un pH égal au pKa, les concentrations des formes acide et basique sont égales selon la relation de Henderson-Hasselbalch.}
    \end{question}
}
...
\element{pkaforce}{
    \begin{question}{pkaforce4}
        ...
        \end{reponses}
        \explain{Un acide de pKa 2 est plus fort qu'un acide de pKa 5 car un pKa plus faible correspond à une constante d'acidité $K_a$ plus élevée.}
    \end{question}
}
...
\element{pkaforce}{
    \begin{question}{pkaforce5}
        ...
        \end{reponses}
        \explain{La relation de Henderson-Hasselbalch est $\ce{pH = pKa + log(\frac{[Base]}{[Acide]})}$ et permet de calculer le pH d'une solution tampon.}
    \end{question}
}
...
\element{pkaforce}{
    \begin{question}{pkaforce6}
        ...
        \end{reponses}
        \explain{Quand le pH est égal au pKa, les concentrations de l'acide et de sa base conjuguée sont égales selon la relation de Henderson-Hasselbalch.}
    \end{question}
}
...
\element{pkaforce}{
    \begin{question}{pkaforce7}
        ...
        \end{reponses}
        \explain{Un acide de pKa 9 est un acide faible car un pKa élevé correspond à une constante d'acidité $K_a$ faible.}
    \end{question}
}
...
\element{pkaforce}{
    \begin{question}{pkaforce8}
        ...
        \begin{reponses}
            ...
            \bonne{$\ce{CH3COO-}$}
        \end{reponses}
        \explain{À un pH de 6,8, supérieur au pKa de 4,8, la forme prédominante est la base conjuguée $\ce{CH3COO-}$ selon la relation de Henderson-Hasselbalch.}
    \end{question}
}
