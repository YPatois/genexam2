...
\textbf{Logarithme: dans cette partie, la fonction $\log$ représente le logarithme décimal ($\Log[10]$).}
\insertgroup[2]{logs}
\end{multicols}

\section{Rappels sur les tampons}

%% Chose one of the tests
\newsavebox{\tempbox}
\begin{lrbox}{\tempbox}
\FPrandom{\yran}
\FPeval{\yran2}{2 * \yran}
\FPclip{\fileChoice}{\yran2}
\end{lrbox}
