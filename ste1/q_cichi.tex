...
\element{cichi}{
  \begin{questionmult}{cichi4}
    Quelle est l'expression de la demi-vie ($t_{1/2}$) pour une réaction du premier ordre (avec $[A]_0$ concentration initiale) ?
    \begin{reponses}
      \mauvaise{$t_{1/2} = [A]_0 / k$}
      \mauvaise{$t_{1/2} = 1 / (k [A]_0)$}
      \mauvaise{$t_{1/2} = k \times [A]_0$}
