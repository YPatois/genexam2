...
molecule_table = [
    ...
    ['2-méthylbutan-1-ol', '3-méthylbutan-1-ol', 'acide 2-méthylbutanoïque', '2-méthylbutanal', '*3-éthylbutan-1-ol', '*3-pentylbutan-1-ol'],
...
# --------------------------------------------------------------------------
def main():
    q=build_all_groups_questions('nomencla',molecule_table)
    f=open("q_nomencla.tex","w")
    f.write(q)
    f.close()
